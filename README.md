...
| Layer | Technologies |
|---|---|
| **Frontend** | React 18, Vite, Bootstrap 5, Axios, React Router v6, Lucide Icons |
...
```
User Browser (React 18 + Bootstrap 5)
       │
       ▼ (REST / JWT)
FastAPI Gateway (/api)
...
│   │   ├── pages/        # Dashboard, Hub, Search, Chat, Compare, Eval
...
## 8. Authors & Academic Credits
- **Author**: Amit Singh Bhadouriya
- **Degree**: Bachelor of Computer Applications (BCA)
- **Project**: Minor Project
- **Repository**: [https://github.com/amitsinghbhadouriya/Ai-document-intelligence-system.git](https://github.com/amitsinghbhadouriya/Ai-document-intelligence-system.git)
